...
Q.1.1. Visit date [pos: 0, field_type: date, condition: false, value: <%= session["datetime"].to_date rescue Date.today%>]

Q.1.3. Height (cm) [pos: 2, min: 15, max: 120, absoluteMin: 15, absoluteMax: 160,  field_type: number, tt_pageStyleClass: NumbersOnlyWithUnknown]

Q.1.4. Weight (grams) [concept: weight, pos: 3, min: 2500, absoluteMin: 100, max: 39999, absoluteMax: 80000, field_type: number, tt_pageStyleClass: NumbersOnlyWithUnknown]
...
Q.1.9. TB status [pos: 11, helpText: Childs TB Status]
...
Q.1.14. Next appointment date [pos: 20, concept: Appointment date, tt_onLoad: showCategory("Next Appointment Date"), field_type: calendar, value: <%= Date.today %>]
